...
URL_Page = 'https://www.arduinothai.com/category/59/electronic-component'
...
for i in Pages:
            ...
            URL = 'https://www.arduinothai.com/category/59/electronic-component?tskp='+str(i)
            ...
            for x in AllProduct:
               ...
               #Scrape Stock    
                 ...
                 if((ProductCategory_jsonData==('รีเลย์ / Relay')) or (ProductCategory_jsonData==('LED')) or (ProductCategory_jsonData==('ก้างปลา/Pin Header/Socket')) 
                     ...
                     or (ProductCategory_jsonData==('สวิตซ์ (Switch)')) or (ProductCategory_jsonData==('ตัวเก็บประจุ (Capacitor)')) or (ProductCategory_jsonData==('ฟิวส์ (Fuse)')) 
                     or (ProductCategory_jsonData==('ไดโอด (Diode)')) or (ProductCategory_jsonData==('ตัวต้านทาน (Resistor)')) or (ProductCategory_jsonData==('พัดลม'))):
