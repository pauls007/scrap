...
URL_Page = 'https://www.arduinothai.com/category/19/ราสเบอรี่พาย-raspberry-pi'
...
for i in Pages:
            ...
            URL = 'https://www.arduinothai.com/category/19/ราสเบอรี่พาย-raspberry-pi?tskp='+str(i)
