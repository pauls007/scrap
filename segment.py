...
URL_Page = 'https://www.arduinothai.com/category/78/7-segment'
...
for i in Pages:
            ...
            for x in AllProduct:
               ...
               #Scrape Stock    
                 ...
                 if((ProductCategory_jsonData==('7 Segment 1 bit')) or (ProductCategory_jsonData==('7 Segment 4 bit')) or (ProductCategory_jsonData==('7 Segment 2 bit')) 
                     or (ProductCategory_jsonData==('อื่นๆ')) or (ProductCategory_jsonData==('7 Segment 3 bit'))):
